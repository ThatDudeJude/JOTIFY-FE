...
describe('Update and Delete Note Test', () => {
  ...
  it('View according to category', () => {
    ...
    cy.intercept(
      {
        method: 'GET',
        url: 'http://127.0.0.1:8000/api/v1/notes/all/quick/',
      },
      {
        statusCode: 200,
        headers: {
    ...
    cy.intercept(
      {
        method: 'GET',
        url: 'http://127.0.0.1:8000/api/v1/notes/all/categorized/2/',
      },
      {
        statusCode: 200,
        headers: {
  ...
  it('Change Note Category', () => {
    ...
    cy.intercept(
      {
        method: 'GET',
        url: 'http://127.0.0.1:8000/api/v1/notes/categorized-note/3',
      },
      {
        statusCode: 200,
        headers: {
    ...
    cy.intercept(
      {
        method: 'DELETE',
        url: 'http://127.0.0.1:8000/api/v1/notes/categorized-note/delete/3/',
      },
      {
        statusCode: 200,
        // headers: {
    ...
    cy.intercept(
      {
        method: 'GET',
        url: 'http://127.0.0.1:8000/api/v1/notes/quick-note/4',
      },
      {
        statusCode: 200,
        headers: {
  ...
  it('Create Note Category and add note', () => {
    ...
    cy.intercept(
      {
        method: 'POST',
        url: 'http://127.0.0.1:8000/api/v1/notes/note-categories/', // ALl user's note types
      },
      {
        statusCode: 200,
        headers: {
    ...
    cy.intercept(
      {
        method: 'GET',
        url: 'http://127.0.0.1:8000/api/v1/notes/categorized-note/4',
      },
      {
        statusCode: 200,
        headers: {
    ...
    cy.intercept(
      {
        method: 'GET',
        url: 'http://127.0.0.1:8000/api/v1/notes/all/categorized/3/',
      },
      {
        statusCode: 200,
        headers: {
  ...
  it('Delete Note Category', () => {
    ...
    cy.intercept(
      {
        method: 'DELETE',
        url: 'http://127.0.0.1:8000/api/v1/notes/note-categories/2',
      },
      {
        statusCode: 200,
        headers: {
